...
class PBDesignController extends Controller
{
    // log callback and present page ?
    public function auth(): bool {
        echo 'This is the info from the server : ';
        $req = $_REQUEST;
        Log::info('this is the auth token for the MS blueyonder project: '. print_r($req,true));
        return print_r($req, true);
    }

    public function index(): View{
        return view('pbdesign-index');
    }

    public function get_token(): string{
        //if(!$_REQUEST['app_id'] === 'b3eca716-1757-4bdf-8169-c3490f04e893') exit();
